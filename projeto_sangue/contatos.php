...
tudo depende de você!</p>
        ...
        <menu id="menu">
        	<ul>
                ...
                <li class="atual"><a href="contatos.php">CONTATO</a></li>
            </ul>
        </menu>
        <section id="conteudo">
        <aside id="esquerda">
...
<form id="area" method="get">
 <h2 class="titu2">Contato</h2>
  <p><br />
    <label class="alinha" >Nome: </label>
    <input type="text" id="nome" placeholder="Nome"/>
    <br />
    <label class="alinha">Email:</label>
    <input type="password" id="email" placeholder="E-mail" />
    <br />
    <label class="alinha">Mensagem:</label>
    <textarea id="mensagem" placeholder="Digite aqui sua mensagem" rows="4" cols="30"></textarea >
    <input type="submit" id="butao" value="enviar"/>
    <br />
  </p>
</form>
